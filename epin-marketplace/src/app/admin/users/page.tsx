  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="text-xs font-mono-accent text-[var(--text-ghost)]">
          Toplam: {users?.length || 0}
        </div>
      </div>
              ...
              {users?.map((u: any) => {
                ...
                return (
                  <tr key={u.id} className="hover:bg-[var(--surface)] transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <Link href={`/admin/users/${u.id}`} className="btn btn-sm btn-primary">Detaylar</Link>
                    </td>
                  </tr>
                );
              })}
