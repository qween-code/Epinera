        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="relative flex gap-4 bg-primary/10 px-4 py-3 dark:bg-primary/20">
            ...
            <div className="flex items-start gap-3 w-full">
              <img className="h-12 w-12 rounded-full object-cover" alt="Avatar of Jane Doe" src="https://api.dicebear.com/7.x/avataaars/svg?seed=JaneDoe"/>
        ...
        <div className="flex-1 overflow-y-auto bg-background-light p-6 dark:bg-background-dark">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start gap-3">
              <img className="h-10 w-10 rounded-full object-cover" alt="Avatar of Jane Doe" src="https://api.dicebear.com/7.x/avataaars/svg?seed=JaneDoe"/>
            ...
            <div className="flex flex-row-reverse items-start gap-3">
              <img className="h-10 w-10 rounded-full object-cover" alt="Avatar of Mehmet's Game Store" src="https://api.dicebear.com/7.x/avataaars/svg?seed=MehmetStore"/>
